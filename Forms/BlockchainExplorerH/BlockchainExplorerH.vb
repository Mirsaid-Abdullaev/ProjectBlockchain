...
Public Class BlockchainExplorerH
        ...
        While Not FormExiting
            If First Then
                ...
                For Each CurrentBlock As Block In TempChain
                    Me.BlockchainTxt.Text &= CurrentBlock.GetHeaderData & vbCrLf & vbCrLf
                Next
    ...
    Private Sub BlockchainExplorerH_Closing(sender As Object, e As EventArgs) Handles Me.Closing
        FormExiting = True
        GC.Collect()
    End Sub
End Class